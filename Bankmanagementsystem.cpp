...
void account::create_account(){
    string temp_acno;
    do{
        cout<<"Please provide your 6-digit Account ID : ";
	    cin>>temp_acno;
        if(temp_acno.size() != 6 || !check_acno(temp_acno) || (get_acno(temp_acno) < 100000)){
            cout<<"⚠️ Account ID must be a 6-digit number.\n\n";
        }
        else if(ac_exists(get_acno(temp_acno)) != -1){ 
            cout<<"⚠️ That account number is already in use.\n\n";
        }
        else{
            break;
        }
    ...
    do{
        ...
        if(name[i] == '\0') break;
        else cout<<"⚠️ Invalid name. Use letters only.\n";
    }while(1);
    ...
    do{
        ...
        cout<<"⚠️ Mobile number must be 10 digits.\n";
    }while(1);

    do{
        cout<<"\nSet Account Security PIN : ";
        cin.getline(pass,20);
        ...
        else cout<<"⚠️ PINs didn't match. Please retry.\n";
    }while(1);
    ...
    while(max_bal<=min_bal){
        cout<<"<--Enter Valid Maximum Balance-->\n";
        cout<<"\nEnter Maximum Balance Limit : Rs ";
	    cin>>max_bal;
    }
...
void account::modify_account()
{
    ...
    cout<<"\nSet New Minimum Balance : Rs ";
	cin>>min_bal;
    min_bal = max(min_bal, 0);

    cout<<"Set New Maximum Balance : Rs ";
	cin>>max_bal;
    max_bal = max(max_bal, min_bal);

    do{
        cout<<"\nSet New Current Balance : Rs ";
	    cin>>balance;
        if(balance < min_bal){
            cout<<"<--Minimum Balance Limit : Rs "<<min_bal<<"-->\n";
        }
...
int login(){
    ...
    do{
        ...
        if(ch == 1){
            ...
            int id=-1;
            do{
                cout<<"Please Please provide your 6-digit Account ID : ";
                cin>>temp_acno;
                if(temp_acno.size() != 6 || !check_acno(temp_acno) || (get_acno(temp_acno) < 100000)){
                    cout<<"⚠️ Account ID must be a 6-digit number.\n\n";
                }
                    ...
                    if(id != -1){ 
                        ...
                        cout<<"⚠️ No matching account found.\n\n";
                        exit(0);
                    }
                }
            }while(1);
...
void show_main_menu(){
	...
	cout<<"\n3. Fund Transfer Panel";
	cout<<"\n4. Deposit / Withdraw Funds";
	cout<<"\n5. Execute Bulk Transactions";
	cout<<"\n0. EXIT";
}
...
void show_user_menu(){
	...
	cout<<"          USER MENU\n";
	cout<<"################################\n";
	cout<<"\n1. SHOW Account Summary & Info";
	cout<<"\n2. MODIFY Account Summary & Info";
	cout<<"\n3. Fund Transfer Panel";
	cout<<"\n4. Deposit / Withdraw Funds";
	cout<<"\n0. EXIT";
}
...
void show_ac_menu(){
	...
	cout<<"\n5. Display All Bank Customers";
	cout<<"\n6. Fund Transfer Panel";
...
{
    cout<<"################################=\n";
	cout<<"           Register New Bank Account\n";
	cout<<"################################=\n";
	account ac;
	ac.create_account();
	Accounts.push_back(ac);
...
void display_all()
{
	cout<<"\n\t\tList of Active Account Holders\n\n";
	cout<<"################################=====================\n";
	cout<<"A/C NO\t\tNAME                \tBALANCE\n";
	cout<<"################################=====================\n";
    int i, n = Accounts.size();
